...
window = pygame.transform.scale(pygame.image.load("window-removebg-preview.png").convert_alpha(), (45, 45))
door = pygame.transform.scale(pygame.image.load("door-removebg-preview.png").convert_alpha(), (60, 60))
